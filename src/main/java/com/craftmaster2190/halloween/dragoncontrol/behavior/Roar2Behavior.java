...
@Component
public class Roar2Behavior implements Behavior {
  private final Dragon dragon;
  private final SoundPlayer soundPlayer;

  public Roar2Behavior(Dragon dragon, @Value("classpath:loud-roar2-9s.wav") Resource soundfile) {
    this.dragon = dragon;
  ...
  public void perform() throws InterruptedException {
    ...
    dragon.getHead().getRightNeck().requestMoveToPercentage(0.8);
