...
@Component
public class RandomRoarAndGrowlSequence1Behavior implements Behavior {
  private final Dragon dragon;
  private final SoundPlayer soundPlayer;

  public RandomRoarAndGrowlSequence1Behavior(Dragon dragon, @Value("classpath:growl-4s-roar-3s-5s-2s-2s-2s-5s.wav") Resource soundfile) {
    this.dragon = dragon;
