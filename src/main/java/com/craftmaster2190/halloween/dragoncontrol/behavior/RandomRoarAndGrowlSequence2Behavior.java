...
@Component
public class RandomRoarAndGrowlSequence2Behavior implements Behavior {
  private final Dragon dragon;
  private final SoundPlayer soundPlayer;

  public RandomRoarAndGrowlSequence2Behavior(Dragon dragon, @Value("classpath:roar-2s-3s-growl-5s-5s.wav") Resource soundfile) {
    this.dragon = dragon;
  ...
  public void perform() throws InterruptedException {
    ...
    dragon.getHead().getJaw().requestMoveToPercentage(0.3);
    TimeUnit.SECONDS.sleep(2);
    dragon.getHead().getJaw().requestMoveToZero();
