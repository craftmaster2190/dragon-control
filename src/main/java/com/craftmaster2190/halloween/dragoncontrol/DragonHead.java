...
public class DragonHead {
  ...
  public DragonHead(PinController pinController) {
    ...
    eyes = new ActuatorState("Eyes", Duration.ofSeconds(1), pinController, Pin.UPPER_LIP_NEGATIVE, Pin.UPPER_LIP_POSITIVE);
    upperLip = new ActuatorState("UpperLip", Duration.ofSeconds(1), pinController, Pin.EYES_NEGATIVE, Pin.EYES_POSITIVE);
  }
